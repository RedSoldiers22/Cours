 ...
 */
class getPlaneteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlaneteRepository' shared autowired service.
     *
     * @return \App\Repository\PlaneteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlaneteRepository.php';

        return $container->privates['App\\Repository\\PlaneteRepository'] = new \App\Repository\PlaneteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
