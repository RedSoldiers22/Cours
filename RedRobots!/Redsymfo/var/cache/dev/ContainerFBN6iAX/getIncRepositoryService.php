 ...
 */
class getIncRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\IncRepository' shared autowired service.
     *
     * @return \App\Repository\IncRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IncRepository.php';

        return $container->privates['App\\Repository\\IncRepository'] = new \App\Repository\IncRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
