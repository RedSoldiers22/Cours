...
<head>
    ...
    <link rel="stylesheet" href="exo_hfe.css">
</head>
<body>
<?php
...
<div id="container">
    ...
    <div id="enfants">
        <h3>Enfants</h3>
    <?php
    for($i = 0 ; $i <count($enfants) ; $i++) //boucle for
    {
        echo '<img src='.$enfants[$i]["photo"].'>'; // /!\
        echo "<br>";
        echo $enfants[$i]["nom_produit"]." : ".$enfants[$i]["prix"]." €"."<br>";
        echo "<br>";
